...
| --- | --- | --- |
| `app/capture` | Receive WebRTC or Continuity Camera frames and native iPhone PDF417 events | Identity decisions |
...
| `app/records` | Search Supabase vectors, identities, licenses, and synthetic records | Embedding generation |
